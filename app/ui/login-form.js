    ...
    return (
        <form action={formAction} className="space-y-3">
            ...
            <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
                ...
                <div className="w-full">
                    <div>
                        ...
                        <div className="relative">
                            <input className="peer block w-full rounded-md border border-gray-200 py-[9px] pl-10 text-sm outline-2 placeholder:text-gray-500" id="username" type="text" name="username" placeholder="Enter your username" required />
                ...
                <div className="mt-4 flex h-8 items-start space-x-1" aria-live="polite" aria-atomic="true">
                    {errorMessage && (
                        <>
