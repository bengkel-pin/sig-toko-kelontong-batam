...
export function ShopSideBarSkeleton() {
    return (
        <div className={`${shimmer} h-min w-full flex pt-6 pb-4 px-4 border-b-2`}>
            <div className="flex-auto">
                <div className="h-6 w-3/4 bg-gray-200 rounded mb-2"></div>
                <div className="h-4 w-1/2 bg-gray-200 rounded"></div>
            </div>
            <div className="flex-none px-2">
                <div className="h-[84px] w-[84px] bg-gray-200 rounded"></div> 
            </div>
        </div>
    );
}

export function ShopsSideBarSkeleton(){
    return (
        <>
            <ShopSideBarSkeleton />
            <ShopSideBarSkeleton />
...
export function DistributionShopsChartSkeleton() {
    return (
...
export function ShopsMobileSkeleton() {
    return (
...
export function LatestShopsSkeleton() {
    return (
